...
;   ARCHIVE_FILE = '/home/simcoe/idl/xidl/Spec/Longslit/pro/MAGE/ARCHIVE/mage_calib/mage_archive_orders.fits' ;'esi_archive_orders.fits'
   ARCHIVE_FILE = '/Users/jhennawi/DATA/MAGE_DATA/mage_redux/mage_archive_orders.fits'

if (n_elements(y1) EQ 0) then y1 = 1375.0
if (n_elements(y2) EQ 0) then y2 = 1400.0
