...
if ngood LT 10  OR med_sn2 LT SN_GAUSS^2 OR KEYWORD_SET(GAUSS) then begin
    ...
    IF ngood GT 0 THEN $
       qa_longslit_profile, (sigma_x < 7) > (-7) $
...
if keyword_set(PROF_NSIGMA) then begin
   ;; JFH this is redundant since l_limit and r_limit are not used
   ;; again. By setting them to zero we ensure QA won't plot
