...
ENDIF ELSE IF strmatch(instrument,'FORS2*') THEN BEGIN
   ...
   ind_gri =  WHERE(stregex(hdr, 'HIERARCH ESO INS GRIS1 NAME', /bool))
   grism =  strmid(hdr[ind_gri], 30, 14)
   grism = (strcompress(repstr(grism, "'", ''), /rem))[0]
   ...
   CASE grism OF
      ...
      'GRIS_1200B': BEGIN
         ...
         wstruct.AUTOID      = 0
         wstruct.REID        = 1
         wstruct.REID_FILE   = '/Users/rubin/Research/FORS2/2011nov25/fors_1200B+97_mswave.sav'
         ;wstruct.REID_FILE   = calib_path + '/fors_300V+10_mswave.sav'
      END
      ELSE: message, 'ERROR: Unknown grism'
   ENDCASE
