...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
pro igm_mk_fn_constraints_z25, cosmc, LYA_FLG=lya_flg
  ...
  case LYA_FLG of
     ...
     1: begin ;; Kim et al. 2002
        ...
        igm_getfn_kim2002, [2.2, 2.6], NHI_mnx, f_STRCT, FLG_COSM=0L
  ...
  nbin = 2
  stp = 0.6
  slls_fnfit_z2, llslst, fgzech, NBIN=nbin, NMIN=19.0, STRCT=slls_strct, XZFIL=xzfil, ZBIN=[1.7, 3.], STP=stp
  ...
  dla_fn.cosm = cosmc
  dla_fn.type = 'DLA'
  dla_fn.comment = '$z=[2.3,2.7]$; modest SDSS bias \citep[see][]{n09,pwo09}?'
...
pro igm_mk_fn_constraints_z37, cosmc, TEFF_flg=TEFF_flg, LYA_FLG=lya_flg
  ...
  ;; EXTEN=3 is the MFP constraints PWO09
...
;  xzfil = init.xzfil
  ...
  case teff_flg of 
     ...
     1: begin ;; Kim et al. 2007
        teff_constr.ref = 'K07' ;; Faucher-Giguerre et al. 2008
        teff_constr.type = '\tlya' ;; teff_Lya  (no LLS, no metals, no DLAs) [aka DA8s]
...
pro igm_mk_fn_constraints, FLG_COSM=flg_cosm, TEFF_FLG=teff_flg, z2_LFLG=z2_LFLG
  ...
  ;; z=2.5
  igm_mk_fn_constraints_z25, cosmc, LYA_FLG=z2_LFLG

  ;; z=3.7
  igm_mk_fn_constraints_z37, cosmc, teff_flg=teff_flg
...
;  lya_fn.ref = 'KT97'
;  lya_fn.type = 'Lya Forest'
;  lya_fn.comment = 'Single sightline'
;  lya_fn.cosm = cosmc ;; Uncertain
;  lya_fn.DX = 20.
;
...
;
;  ;; BOOST (kludge)
;  log_lyafn[2] = log_lyafn[2]+0.25
;  log_lyafn[8] = log_lyafn[8]+0.25
;  ;;
;
...
;
;  N1 = 11.7 - 0.18 + findgen(10)*0.36
;  N2 = 11.7 + 0.18 + findgen(10)*0.36
;  dN = 10.d^N2 - 10.d^N1
;
;  lya_fn.npt = 8
;  idx = (10-lya_fn.npt) + lindgen(lya_fn.npt)
;  lya_fn.NHI[0:lya_fn.npt-1] = lyabin[idx]
;  lya_fn.dN[0:lya_fn.npt-1] = dN[idx]
;  lya_fn.bins[0:lya_fn.npt-1,0] = N1[idx]
;  lya_fn.bins[0:lya_fn.npt-1,1] = N2[idx]
;
;  lya_fn.fN[0:lya_fn.npt-1] = log_lyafn[idx]
;  lya_fn.sig_fN[0:lya_fn.npt-1,0] = 0.1 ;; By-eye estimate
;  lya_fn.sig_fN[0:lya_fn.npt-1,1] = 0.1
